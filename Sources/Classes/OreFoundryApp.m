...
#import "OreFoundryApp.h"

@implementation OreFoundryApp
		  ...
		  withReason:(NSString *)reason
{
	...
	NSError * error = [NSError errorWithDomain:@"Ore Foundry" code:errorCode userInfo:dict];
...
/**
    ...
    store file.  This code uses a directory named "Ore Foundry" for
...
- (NSString *) applicationSupportDirectory {
    ...
    return [basePath stringByAppendingPathComponent:@"OreFoundry"];
}
...
{
	NSLog(@"Trying to terminate application.");
